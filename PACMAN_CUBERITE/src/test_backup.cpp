...
//            num_com++;
        ...
        if ( (arr_len>10000 || arr_cnt>25) || skipper==1) {
            num_command_blocks++;
            if (skipper==1) {
                sprintf(line,"{id:command_block_minecart,Command:'setblock %d 5 %d minecraft:glowstone'},",1+prevx*16,1+prevz*16);
                strcpy(arr_between[arr_cnt], line); arr_len+=strlen(line); arr_cnt++;
...
//        } else
        ...
        else printf(" Plotting: %s",fname.c_str());
    }
                ...
                for (int z = 0; z < zl; z++) {
                    ...
                    for (int y = height_add; y < 256; y++) {
                        if (AY[y].id!=0 && AY[y].id!=8 && AY[y].id!=46) {
                            num_blocks_total++;
                            int b1=int( ( sin( float(xx)/149.83 + 0.15*sin( float(y)/185.83 ) ) + sin( float(y)/235.83 ) +  float(zz+ 0.17*sin( float(xx)/159.83 ) )/159.51 + 2.0)*100.0  )%150;
                            int b2=int( ( sin( float(xx+ 0.2*sin( float(zz)/195.83 ) )/179.83 ) + sin( float(y)/145.83 ) +  float(zz)/379.51 + 2.0)*100.0  + 0.33*sin( float(y)/215.83 ) )%150;
                            if ( b1==75 || b2==75 ||  b1==76 || b2==76 || (b1+b2)%150==75 || (b1+b2)%150==76  || (b1*2-b2)%150==40 || (b1-b2*2)%150==120
//                                ( y>height_add+3 && (xx+zz+y) % (int(60.0+(sin((float)zz/87.0) + sin((float)y/77.0)  + sin((float)xx/99.0))*18.0)) < 1+rand()%2) ||
//                                (y%(int(60.0+(sin((float)zz/183.0)  + sin((float)xx/250.0))*25.0)) < 1+rand()%2) ||
//                                (y%(int(110.0+(sin((float)xx/223.0) + sin((float)zz/175.0))*25.0)) < 1+rand()%2) ||
//                                (y%(int(160.0+(sin((float)zz/243.0) + sin((float)xx/157.0))*25.0)) < 1+rand()%2)

//                                    y == int(128   + (sin((float)zz/50.0) + sin((float)xx/50.0))*50.0 )

                                ) {
//                                setExtra2(x,z,y,"minecraft:tnt",SomeStuff);
                                if (!(rand()%100 && y<255)) {
                                    if (AY[y+1].id==0) AY[y+1]=BlockInfo(46,0,0,0);
                                    num_blocks_total++;
                                }
                                if (x-1>=0  && AX[x-1][z][y].id==0 && skylight[x-1][z][y]==0) { num_blocks_total++;AX[x-1][z][y-1]=BlockInfo(46,0,0,0); if (AX[x-1][z][y-1].id==0) AX[x-1][z][y-1]=BlockInfo(1,0,0,0);}
                                if (x+1<512 && AX[x+1][z][y].id==0 && skylight[x+1][z][y]==0) { num_blocks_total++;AX[x+1][z][y-1]=BlockInfo(46,0,0,0); if (AX[x+1][z][y-1].id==0) AX[x+1][z][y-1]=BlockInfo(1,0,0,0);}
                                if (z-1>=0  && AX[x][z-1][y].id==0 && skylight[x][z-1][y]==0) { num_blocks_total++;AX[x][z-1][y-1]=BlockInfo(46,0,0,0); if (AX[x][z-1][y-1].id==0) AX[x][z-1][y-1]=BlockInfo(1,0,0,0);}
                                if (z+1<512 && AX[x][z+1][y].id==0 && skylight[x][z+1][y]==0) { num_blocks_total++;AX[x][z+1][y-1]=BlockInfo(46,0,0,0); if (AX[x][z+1][y-1].id==0) AX[x][z+1][y-1]=BlockInfo(1,0,0,0);}
                                if (y-1>=0  && AX[x][z][y-1].id==0 && skylight[x][z][y-1]==0) { num_blocks_total++;AX[x][z][y-1-1]=BlockInfo(46,0,0,0); if (AX[x][z][y-1-1].id==0) AX[x][z][y-1-1]=BlockInfo(1,0,0,0);}
                                if (y+1<512 && AX[x][z][y+1].id==0 && skylight[x][z][y+1]==0) { num_blocks_total++;AX[x][z][y+1-1]=BlockInfo(46,0,0,0); if (AX[x][z][y+1-1].id==0) AX[x][z][y+1-1]=BlockInfo(1,0,0,0);}

//                                if (!(rand()%2)) if (x-1>=0  && AX[x-1][z][y].id==0) { AX[x-1][z][y-1]=BlockInfo(46,0,0,0); if (AX[x-1][z][y-1].id==0) AX[x-1][z][y-2]=BlockInfo(1,0,0,0);}
//                                if (!(rand()%2)) if (x+1<512 && AX[x+1][z][y].id==0) { AX[x+1][z][y-1]=BlockInfo(46,0,0,0); if (AX[x+1][z][y-1].id==0) AX[x+1][z][y-2]=BlockInfo(1,0,0,0);}
//                                if (!(rand()%2)) if (z-1>=0  && AX[x][z-1][y].id==0) { AX[x][z-1][y-1]=BlockInfo(46,0,0,0); if (AX[x][z-1][y-1].id==0) AX[x][z-1][y-2]=BlockInfo(1,0,0,0);}
//                                if (!(rand()%2)) if (z+1<512 && AX[x][z+1][y].id==0) { AX[x][z+1][y-1]=BlockInfo(46,0,0,0); if (AX[x][z+1][y-1].id==0) AX[x][z+1][y-2]=BlockInfo(1,0,0,0);}
//                                if (!(rand()%2)) if (y-1>=0  && AX[x][z][y-1].id==0) { AX[x][z][y-1-1]=BlockInfo(46,0,0,0); if (AX[x][z][y-1-1].id==0) AX[x][z][y-1-2]=BlockInfo(1,0,0,0);}
//                                if (!(rand()%2)) if (y+1<512 && AX[x][z][y+1].id==0) { AX[x][z][y+1-1]=BlockInfo(46,0,0,0); if (AX[x][z][y+1-1].id==0) AX[x][z][y+1-2]=BlockInfo(1,0,0,0);}

//                                if (!(rand()%2)) if (x-1>=0  && AX[x-1][z][y].id==0) { setExtra2(x-1,z,y,"minecraft:tnt",SomeStuff); if (AX[x-1][z][y-1].id==0) setExtra2(x-1,z,y-1,"minecraft:stone",SomeStuff);}
//                                if (!(rand()%2)) if (x+1<512 && AX[x+1][z][y].id==0) { setExtra2(x+1,z,y,"minecraft:tnt",SomeStuff); if (AX[x+1][z][y-1].id==0) setExtra2(x+1,z,y-1,"minecraft:stone",SomeStuff);}
//                                if (!(rand()%2)) if (z-1>=0  && AX[x][z-1][y].id==0) { setExtra2(x,z-1,y,"minecraft:tnt",SomeStuff); if (AX[x][z-1][y-1].id==0) setExtra2(x,z-1,y-1,"minecraft:stone",SomeStuff);}
//                                if (!(rand()%2)) if (z+1<512 && AX[x][z+1][y].id==0) { setExtra2(x,z+1,y,"minecraft:tnt",SomeStuff); if (AX[x][z+1][y-1].id==0) setExtra2(x,z+1,y-1,"minecraft:stone",SomeStuff);}
//                                if (!(rand()%2)) if (y-1>=0  && AX[x][z][y-1].id==0) { setExtra2(x,z,y-1,"minecraft:tnt",SomeStuff); if (AX[x][z][y-1-1].id==0) setExtra2(x,z,y-1-1,"minecraft:stone",SomeStuff);}
//                                if (!(rand()%2)) if (y+1<512 && AX[x][z][y+1].id==0) { setExtra2(x,z,y+1,"minecraft:tnt",SomeStuff); if (AX[x][z][y+1-1].id==0) setExtra2(x,z,y+1-1,"minecraft:stone",SomeStuff);}
                            }
                        }
                    }
                }
            ...
            for (int x = 0; x < xl; x++) {
                ...
                for (int z = 0; z < zl; z++) {
                    BlockInfo* AY=AZ[z];
                    zz=z+chunk_offsetz*16;
                    for (int y = height_add; y < 255; y++) {
                        if (skylight[x][z][y]==0) {
                            if (xx%8==4 && zz%10==5 && y%8==0 && skylight[x][z][y+1]==0) {
                                AY[y]=BlockInfo(89,0,0,0);
                                continue;
                            }
                            if (((zz%10==0 && xx%8==4) || (xx%8==0 && zz%10==5)) && (y%8==1 || y%8==2)) {
                                continue;
                            }
                            if (AY[y].id==0 && (zz%10==0 || xx%8==0 || y%8==0)) {
                                AY[y]=BlockInfo(1,0,0,0);
                                num_blocks_total++;
                                filled++;
                                if (y%8==0 && !(xx%8==0 || zz%10==0) && y<254) {
                                    if (AY[y+1].id==0 && !(rand()%1000)) {
                                        ...
                                        if (AY[y+2].id==0 && !(rand()%2)) {
                                            Pos position(region.x_ori + xx, region.z_ori + zz, region.y_ori + y+2);
                                            Pos position2(region.x_ori + x, region.z_ori + z, region.y_ori + y+2);
                                            MobEntity* mob;
                                            if (n==0) mob = new MobEntity(position, "minecraft:pig");
                                            else if (n==1) mob = new MobEntity(position, "minecraft:sheep");
                                            else if (n==2) mob = new MobEntity(position, "minecraft:chicken");
...
//                                }
        ...
        if (maze_on) {
            add_maze_to_region(region, region_x, region_z, 16, 7, 1);
            add_maze_to_region(region, region_x, region_z, 23, -5, 0);

            add_maze_to_region(region, region_x, region_z, 170, 5, 3);
            add_maze_to_region(region, region_x, region_z, 176, -5, 2);
        }
    ...
    //                                                    setExtra(x,z,y,"minecraft:glowstone");   AX[x][z][y]=BlockInfo(1000,0,0,0);
                                        ...
                                        int what=(int)t%64;
                                        if (what==0 || what==0+8 || what== 7+8*2 || what==3+8*3 || what==3+8*4 || what==4+8*5 || what==5+8*6 || what==0+8*7) { setExtra2(x,z,y,"minecraft:tube_coral_block",SomeStuff);   AX[x][z][y]=BlockInfo(1000,0,0,0); coral++;}
                                        if (what==1 || what==1+8 || what== 6+8*2 || what==4+8*3 || what==7+8*4 || what==2+8*5 || what==4+8*6 || what==7+8*7) { setExtra2(x,z,y,"minecraft:brain_coral_block",SomeStuff);  AX[x][z][y]=BlockInfo(1000,0,0,0); coral++; }
                                        if (what==2 || what==4+8 || what== 1+8*2 || what==2+8*3 || what==2+8*4 || what==6+8*5 || what==6+8*6 || what==2+8*7) { setExtra2(x,z,y,"minecraft:bubble_coral_block",SomeStuff); AX[x][z][y]=BlockInfo(1000,0,0,0); coral++; }
                                        if (what==3 || what==3+8 || what== 2+8*2 || what==7+8*3 || what==4+8*4 || what==7+8*5 || what==7+8*6 || what==3+8*7) { setExtra2(x,z,y,"minecraft:fire_coral_block",SomeStuff);   AX[x][z][y]=BlockInfo(1000,0,0,0); coral++; }
                                        if (what==4 || what==7+8 || what== 4+8*2 || what==5+8*3 || what==6+8*4 || what==1+8*5 || what==3+8*6 || what==1+8*7) { setExtra2(x,z,y,"minecraft:horn_coral_block",SomeStuff);   AX[x][z][y]=BlockInfo(1000,0,0,0); coral++; }
                                        if (what==5 || what==5+8 || what== 5+8*2 || what==1+8*3 || what==5+8*4 || what==0+8*5 || what==2+8*6 || what==4+8*7) { AX[x][z][y]=BlockInfo(8,0,0,0); }
                                        if (what==6 || what==6+8 || what== 0+8*2 || what==0+8*3 || what==0+8*4 || what==3+8*5 || what==1+8*6 || what==6+8*7) { AX[x][z][y]=BlockInfo(8,0,0,0); }
                                        if (what==7 || what==2+8 || what== 3+8*2 || what==6+8*3 || what==1+8*4 || what==5+8*5 || what==0+8*6 || what==5+8*7) { AX[x][z][y]=BlockInfo(8,0,0,0); }
    ...
    */
    ...
    //                                                    int t=(int)(10+3.25*(  (float)(rand()%25)/80.0 + sin((float(xx)+sin(float(zz)/43)*4)/(15.0+sin(float(zz)/42.0)*5.0))+sin((float(zz)+sin(float(xx)/43)*4)/(15.0+sin((float)(y+100)/42.0)*5.0))+sin(((float)(y+100)+sin((float(zz)+float(xx))/47)*3)/(15.0+sin(float(xx)/41.0)*5.0)) ));
                                        int what=(int)t%64;
                                        if (what==0 || what==0+8 || what== 7+8*2 || what==3+8*3 || what==3+8*4 || what==4+8*5 || what==5+8*6 || what==0+8*7){ setExtra2(x,z,y,"minecraft:tube_coral_block",SomeStuff);   AX[x][z][y]=BlockInfo(1001,0,0,0);  coral++;}
                                        if (what==1 || what==1+8 || what== 6+8*2 || what==4+8*3 || what==7+8*4 || what==2+8*5 || what==4+8*6 || what==7+8*7){ setExtra2(x,z,y,"minecraft:brain_coral_block",SomeStuff);  AX[x][z][y]=BlockInfo(1001,0,0,0);  coral++;}
                                        if (what==2 || what==4+8 || what== 1+8*2 || what==2+8*3 || what==2+8*4 || what==6+8*5 || what==6+8*6 || what==2+8*7){ setExtra2(x,z,y,"minecraft:bubble_coral_block",SomeStuff); AX[x][z][y]=BlockInfo(1001,0,0,0);  coral++;}
                                        if (what==3 || what==3+8 || what== 2+8*2 || what==7+8*3 || what==4+8*4 || what==7+8*5 || what==7+8*6 || what==3+8*7){ setExtra2(x,z,y,"minecraft:fire_coral_block",SomeStuff);   AX[x][z][y]=BlockInfo(1001,0,0,0);  coral++;}
                                        if (what==4 || what==7+8 || what== 4+8*2 || what==5+8*3 || what==6+8*4 || what==1+8*5 || what==3+8*6 || what==1+8*7){ setExtra2(x,z,y,"minecraft:horn_coral_block",SomeStuff);   AX[x][z][y]=BlockInfo(1001,0,0,0);  coral++;}
                                        if (what==5 || what==5+8 || what== 5+8*2 || what==1+8*3 || what==5+8*4 || what==0+8*5 || what==2+8*6 || what==4+8*7){ AX[x][z][y]=BlockInfo(8,0,0,0); }
                                        if (what==6 || what==6+8 || what== 0+8*2 || what==0+8*3 || what==0+8*4 || what==3+8*5 || what==1+8*6 || what==6+8*7){ AX[x][z][y]=BlockInfo(8,0,0,0); }
                                        if (what==7 || what==2+8 || what== 3+8*2 || what==6+8*3 || what==1+8*4 || what==5+8*5 || what==0+8*6 || what==5+8*7){ AX[x][z][y]=BlockInfo(8,0,0,0); }
    /*
    ...
    */
    ...
    //                                                    int t=(int)(10+3.25*(  (float)(rand()%25)/80.0 + sin((xx+sin(float(zz)/43)*4)/(15.0+sin(float(zz)/42.0)*5.0))+sin((float(zz)+sin(float(xx)/43)*4)/(15.0+sin((float)y/42.0)*5.0))+sin(((float)y+sin((float(zz)+float(xx))/47)*3)/(15.0+sin(float(xx)/41.0)*5.0)) ));
                                        int what=(int)t%64;
                                        if (what==0 || what==0+8 || what== 7+8*2 || what==3+8*3 || what==3+8*4 || what==4+8*5 || what==5+8*6 || what==0+8*7) { setExtra2(x,z,y,"minecraft:tube_coral_block",SomeStuff);   AX[x][z][y]=BlockInfo(1002,0,0,0);  coral++;}
                                        if (what==1 || what==1+8 || what== 6+8*2 || what==4+8*3 || what==7+8*4 || what==2+8*5 || what==4+8*6 || what==7+8*7) { setExtra2(x,z,y,"minecraft:brain_coral_block",SomeStuff);  AX[x][z][y]=BlockInfo(1002,0,0,0);  coral++;}
                                        if (what==2 || what==4+8 || what== 1+8*2 || what==2+8*3 || what==2+8*4 || what==6+8*5 || what==6+8*6 || what==2+8*7) { setExtra2(x,z,y,"minecraft:bubble_coral_block",SomeStuff); AX[x][z][y]=BlockInfo(1002,0,0,0);  coral++;}
                                        if (what==3 || what==3+8 || what== 2+8*2 || what==7+8*3 || what==4+8*4 || what==7+8*5 || what==7+8*6 || what==3+8*7) { setExtra2(x,z,y,"minecraft:fire_coral_block",SomeStuff);   AX[x][z][y]=BlockInfo(1002,0,0,0);  coral++;}
                                        if (what==4 || what==7+8 || what== 4+8*2 || what==5+8*3 || what==6+8*4 || what==1+8*5 || what==3+8*6 || what==1+8*7) { setExtra2(x,z,y,"minecraft:horn_coral_block",SomeStuff);   AX[x][z][y]=BlockInfo(1002,0,0,0);  coral++;}
                                        if (what==5 || what==5+8 || what== 5+8*2 || what==1+8*3 || what==5+8*4 || what==0+8*5 || what==2+8*6 || what==4+8*7) { AX[x][z][y]=BlockInfo(8,0,0,0); }
                                        if (what==6 || what==6+8 || what== 0+8*2 || what==0+8*3 || what==0+8*4 || what==3+8*5 || what==1+8*6 || what==6+8*7) { AX[x][z][y]=BlockInfo(8,0,0,0); }
                                        if (what==7 || what==2+8 || what== 3+8*2 || what==6+8*3 || what==1+8*4 || what==5+8*5 || what==0+8*6 || what==5+8*7) { AX[x][z][y]=BlockInfo(8,0,0,0); }
    /*
                        ...
                        if (AX[x][z][y].id==8) {
                            ...
                            if ( (t<50 && (rand()%10)<5) || rand()%(1+t ) == 0 ) {
                                ...
                                if (wall==1 && (rand()%2)==0) {
                                    ...
                                    int what=(int)t%5;
                                    if (what==0) { setExtra2(x,z,y,"minecraft:tube_coral_fan",SomeStuff);  AX[x][z][y]=BlockInfo(1004,0,0,0);  coral++;}
                                    if (what==1) { setExtra2(x,z,y,"minecraft:brain_coral_fan",SomeStuff); AX[x][z][y]=BlockInfo(1004,0,0,0);  coral++;}
                                    if (what==2) { setExtra2(x,z,y,"minecraft:bubble_coral_fan",SomeStuff);AX[x][z][y]=BlockInfo(1004,0,0,0);  coral++;}
                                    if (what==3) { setExtra2(x,z,y,"minecraft:fire_coral_fan",SomeStuff);  AX[x][z][y]=BlockInfo(1004,0,0,0);  coral++;}
                                    if (what==4) { setExtra2(x,z,y,"minecraft:horn_coral_fan",SomeStuff);  AX[x][z][y]=BlockInfo(1004,0,0,0);  coral++;}
    /*
                                    if (what==0) { setExtra(x,z,y,"minecraft:tube_coral_fan");  AX[x][z][y]=BlockInfo(1004,0,0,0); }
                                    if (what==1) { setExtra(x,z,y,"minecraft:brain_coral_fan"); AX[x][z][y]=BlockInfo(1004,0,0,0); }
                                    if (what==2) { setExtra(x,z,y,"minecraft:bubble_coral_fan");AX[x][z][y]=BlockInfo(1004,0,0,0); }
    ...
    */
                                    ...
                                    float t=(10+3.25*(  (float)(rand()%25)/80.0 + sin((float(xx)+sin(float(zz)/43)*4)/(15.0+sin(float(zz)/42.0)*5.0))+sin((float(zz)+sin(float(xx)/43)*4)/(15.0+sin((float)(y+100)/42.0)*5.0))+sin(((float)(y+100)+sin((float(zz)+float(xx))/47)*3)/(15.0+sin(float(xx)/41.0)*5.0)) ));
                                    int what=(int)t%5;
                                    if (what==0) { setExtra2(x,z,y,"minecraft:tube_coral",SomeStuff);  AX[x][z][y]=BlockInfo(1004,0,0,0);  coral++;}
                                    if (what==1) { setExtra2(x,z,y,"minecraft:brain_coral",SomeStuff); AX[x][z][y]=BlockInfo(1004,0,0,0);  coral++;}
                                    if (what==2) { setExtra2(x,z,y,"minecraft:bubble_coral",SomeStuff);AX[x][z][y]=BlockInfo(1004,0,0,0);  coral++;}
                                    if (what==3) { setExtra2(x,z,y,"minecraft:fire_coral",SomeStuff);  AX[x][z][y]=BlockInfo(1004,0,0,0);  coral++;}
                                    if (what==4) { setExtra2(x,z,y,"minecraft:horn_coral",SomeStuff);  AX[x][z][y]=BlockInfo(1004,0,0,0);  coral++;}
    /*
                                    if (what==0) { setExtra(x,z,y,"minecraft:tube_coral");   AX[x][z][y]=BlockInfo(1004,0,0,0); }
                                    if (what==1) { setExtra(x,z,y,"minecraft:brain_coral");  AX[x][z][y]=BlockInfo(1004,0,0,0); }
                                    if (what==2) { setExtra(x,z,y,"minecraft:bubble_coral"); AX[x][z][y]=BlockInfo(1004,0,0,0); }
                        ...
                        if (AX[x][z][y].id==8) {
                            ...
                            if ( ((t<(15+t2*4) && (rand()%10)<(t2)) || ( rand()%(1+t )==0 && (rand()%25)<(t2) )) && t>(-15+t2*3+t/20) ) {
                                ...
                                if (wall==1 && (rand()%2)==0) {
                                    ...
                                    int what=(int)t%30;
                                    what=rand()%64;
                                    if (what==0 || what==0+8 || what== 7+8*2 || what==3+8*3 || what==3+8*4 || what==4+8*5 || what==5+8*6 || what==0+8*7) { setExtra2(x,z,y,"minecraft:tube_coral_fan",SomeStuff);  AX[x][z][y]=BlockInfo(1004,0,0,0); coral++;}
                                    if (what==1 || what==1+8 || what== 6+8*2 || what==4+8*3 || what==7+8*4 || what==2+8*5 || what==4+8*6 || what==7+8*7) { setExtra2(x,z,y,"minecraft:brain_coral_fan",SomeStuff); AX[x][z][y]=BlockInfo(1004,0,0,0); coral++;}
                                    if (what==2 || what==4+8 || what== 1+8*2 || what==2+8*3 || what==2+8*4 || what==6+8*5 || what==6+8*6 || what==2+8*7) { setExtra2(x,z,y,"minecraft:bubble_coral_fan",SomeStuff);AX[x][z][y]=BlockInfo(1004,0,0,0); coral++;}
                                    if (what==3 || what==3+8 || what== 2+8*2 || what==7+8*3 || what==4+8*4 || what==7+8*5 || what==7+8*6 || what==3+8*7) { setExtra2(x,z,y,"minecraft:fire_coral_fan",SomeStuff);  AX[x][z][y]=BlockInfo(1004,0,0,0); coral++;}
                                    if (what==4 || what==7+8 || what== 4+8*2 || what==5+8*3 || what==6+8*4 || what==1+8*5 || what==3+8*6 || what==1+8*7) { setExtra2(x,z,y,"minecraft:horn_coral_fan",SomeStuff);  AX[x][z][y]=BlockInfo(1004,0,0,0); coral++;}
    //                                                if (what==5 || what==5+8 || what== 5+8*2 || what==1+8*3 || what==5+8*4 || what==0+8*5 || what==2+8*6 || what==4+8*7)
    //                                                if (what==6 || what==6+8 || what== 0+8*2 || what==0+8*3 || what==0+8*4 || what==3+8*5 || what==1+8*6 || what==6+8*7)
    //                                                if (what==7 || what==2+8 || what== 3+8*2 || what==6+8*3 || what==1+8*4 || what==5+8*5 || what==0+8*6 || what==5+8*7)
...
//        }
        ...
        if (!plotting) printf("\n");
        printf("\r%8d added. %8d replaced. Total = %8d = %5.2f%%  tears = %d  water=%d  coral=%d\n",
            num_blocks_added, num_blocks_replaced, num_blocks_total, 100.0*(float)num_blocks_total/(512*512*256),tears,water,coral);
    }
    printf("REGION=[%d][%d]  RR=[%3d-%3d] Y=[%3d-%3d] ZZ=[%3d-%3d] ",region_x,region_z,real_min_x,real_max_x,real_min_y,real_max_y,real_min_z,real_max_z);
...
void make_one_plot_WINMAIN(int x, int y, sf::Image* image, int type) {
    ...
    int add=0;
    int add2=250;
    if (type>1) { type-=2; add=250; add2=0; }
    ...
    for (int yy=-5; yy<512+5; yy++) {
        for (int xx=-5; xx<512+5; xx++) {
            if (type==0) { //vertical
                if (
                    ( (x+xx+3+5)%500)==add ||
                    ( ((y+yy+3+5)%500)==add2 && ( abs((x+xx+3+5)%500 - add) ) <= 143)
                ...
                if (
                     ((y+yy+3+5)%500)==add ||
                    ( ((x+xx+3+5)%500)==add2 && ( abs((y+yy+3+5)%500 - add) ) <= 143)
...
//                                            AY[y+3]=BlockInfo();
                ...
                else if (y==bottom+3-2 && (((int)xx+3)%5)==0 && (((int)zz+3)%5)==0 && pixel!=0) { AY[y] = BlockInfo(251, 0, ret_color(rand()%256,rand()%256,rand()%256),0 );  }
                else if (y==bottom+3-2) {  if (pixel!=0 )      AY[y] = BlockInfo(95, 0, ret_color(rand()%256,rand()%256,rand()%256),0 );  }
