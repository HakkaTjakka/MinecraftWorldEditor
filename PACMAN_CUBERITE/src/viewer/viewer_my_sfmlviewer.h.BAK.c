...
//                    switch_to_full_screen=1;
    ...
    //                        backgroundImage.loadFromFile("image960x540.png");
                        if (screensaver) contextSettings.antialiasingLevel = 2;
...
//                    if (videomode[win_num]==0 || screensaver) {
...
*/
                            ...
                            window.create(sf::VideoMode(1920,1080,32), window_title, sf::Style::None | sf::Style::Fullscreen, contextSettings);
//                        }
                        window.setVerticalSyncEnabled(true);
...
//                        window.create(sf::VideoMode(1920,1080), window_title, sf::Style::None , contextSettings);
