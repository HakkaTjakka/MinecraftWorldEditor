...
void gen_maze3d(int gif, int c, int r, int w, int h, int s) {
	char *maze_data;
...
void gen_maze2_3d(int gif, int c, int r, int w, int h, int s) {
	char *maze_data;
...
void generate_maze3d(int width,int height,int seed) {
//	char *maze_data;
