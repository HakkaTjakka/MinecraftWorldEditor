...
ffmpeg -y -framerate 30 -f gdigrab -i desktop -vf mpdecimate,setpts=N/FRAME_RATE/TB -s 1920x1080 -c:v h264_nvenc -profile:v high -pixel_format nv12 -b:v 10000k -bufsize 20000k -bf:v 2 -preset slow -rc:v vbr_hq -rc-lookahead 20 -r 30 recording_high3.mp4
