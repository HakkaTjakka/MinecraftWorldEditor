...
void main(){
	...
	// Camera Setup.
	vec3 lookAt = vec3(0.0, 0.0, iTime*0.6);  // "Look At" position.
	...
	if(t < FAR){
        ...
        sn = doBumpMap(texture_in, sp*tSize0, sn, 0.02);
        ...
        vec3 texCol = tex3D(texture_in, sp*tSize0, sn);
