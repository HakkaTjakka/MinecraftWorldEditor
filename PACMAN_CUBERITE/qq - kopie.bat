...
rem ffmpeg -y -framerate 30 -f gdigrab -i title="Minecraft 1.14.4" -s 1920x1080 -c:v h264_nvenc -profile:v high -pixel_format nv12 -b:v 10000k -bufsize 20000k -bf:v 2 -preset slow -rc:v vbr_hq -rc-lookahead 20 -r 30 recording_high3.mp4

rem ffmpeg -y -framerate 30 -f gdigrab -i desktop -c:v h264_nvenc -profile:v high -pixel_format nv12 -b:v 10000k -bufsize 20000k -bf:v 2 -preset slow -rc:v vbr_hq -rc-lookahead 20 -r 30 recording_high3.mp4

rem rem ffmpeg -y -framerate 30 -f gdigrab -i desktop -vf mpdecimate,setpts=N/FRAME_RATE/TB -s 1920x1080 -c:v h264_nvenc -profile:v high -pixel_format nv12 -b:v 10000k -bufsize 20000k -bf:v 2 -preset slow -rc:v vbr_hq -rc-lookahead 20 -r 30 recording_high3.mp4

rem ffmpeg -y -framerate 30 -f gdigrab -i desktop -vf mpdecimate,setpts=0.10*PTS -s 1920x1080 -c:v h264_nvenc -profile:v high -pixel_format nv12 -b:v 10000k -bufsize 20000k -bf:v 2 -preset slow -rc:v vbr_hq -rc-lookahead 20 -r 30 recording_high3.mp4

rem ffmpeg -y -framerate 30 -f gdigrab -i desktop -vf mpdecimate -s 1920x1080 -c:v h264_nvenc -profile:v high -pixel_format nv12 -b:v 10000k -bufsize 20000k -bf:v 2 -preset fast -rc:v vbr_hq -rc-lookahead 20 -r 30 recording_high3.mp4
...
rem ffmpeg -y -framerate 30 -f gdigrab -i title="Minecraft* 1.15.2 - Singleplayer" -vf mpdecimate,setpts=0.25*PTS -s 1920x1080 -c:v h264_nvenc -profile:v high -pixel_format yuv420p -b:v 10000k -bufsize 20000k -bf:v 2 -preset fast -rc:v vbr_hq -rc-lookahead 20 -r 60 recording_high3.mp4


rem ffmpeg -y -framerate 60 -f gdigrab -i title="Minecraft* 1.15.2 - Multiplayer (3rd-party)" -vf mpdecimate,setpts=N/FRAME_RATE/TB -c:v h264_nvenc -profile:v high -pixel_format nv12 -b:v 10000k -preset slow -bf:v 2 -rc vbr_hq -rc-lookahead 32 -r 60 output.mp4


REM ffmpeg -y -framerate 30 -f gdigrab -i title="Minecraft" -vf mpdecimate -s 1920x1080 -c:v h264_nvenc -profile:v high -pixel_format yuv420p -b:v 10000k -bufsize 20000k -bf:v 2 -preset fast -rc:v vbr_hq -rc-lookahead 20 -r 30 recording_high3.mp4

rem ffmpeg -y -framerate 30 -hide_banner -f dshow -i video="screen-capture-recorder":audio="Microfoon (HD Webcam C310)" -r 1 -vf settb=\(1/60\),setpts=N/TB/60 -r 60 -c:v libx264 -preset veryfast -crf 23 -c:a copy -pix_fmt yuv420p 	output.mp4

rem setpts=0.50*PTS
rem -filter:v "setpts=0.50*PTS"

rem ffmpeg -y -framerate 30 -f gdigrab -i desktop -s 1920x1080 -c:v h264_nvenc -profile:v high -pixel_format nv12 -b:v 10000k -bufsize 20000k -bf:v 2 -preset slow -rc:v vbr_hq -rc-lookahead 20 -r 30 recording_high3.mp4
...
rem ffmpeg -y -framerate 60 -f gdigrab -i title="Minecraft 1.14.4" -vf mpdecimate,setpts=N/FRAME_RATE/TB -s 1920x1080 -c:v h264_nvenc -pixel_format nv12 -b:v 8M -bufsize 16M -profile:v main -bf:v 3 -preset slow -rc:v vbr_hq -rc-lookahead 20 -r 60 recording_high3.mp4
...
ffmpeg -thread_queue_size 1024 -y -hide_banner -f gdigrab -i desktop -f dshow -i audio="CABLE Output (VB-Audio Virtual Cable)" -c:v libx264rgb -crf 0 -preset ultrafast recording_FAST2.mkv
