...
REM java -jar converter.jar --headless -- "srcWorld './test-2'" "dstWorld './RESULT1'" "inFormat Anvil" "outFormat CubicChunks" "converter Default"
REM echo move all by 0 -16 0 > relocatingConfig.txt
REM java -jar converter.jar --headless -- "srcWorld './RESULT1'" "dstWorld './RESULT2'" "inFormat CubicChunks" "outFormat CubicChunks" "converter Relocating"
REM 
REM java -jar converter.jar --headless -- "srcWorld './test-1'" "dstWorld './RESULT2'" "inFormat Anvil" "outFormat CubicChunks" "converter Default"
REM echo move all by 0 -16 0 > relocatingConfig.txt
REM java -jar converter.jar --headless -- "srcWorld './RESULT2'" "dstWorld './RESULT3'" "inFormat CubicChunks" "outFormat CubicChunks" "converter Relocating"
REM 
REM java -jar converter.jar --headless -- "srcWorld './test0'" "dstWorld './RESULT3'" "inFormat Anvil" "outFormat CubicChunks" "converter Default"
REM echo move all by 0 -16 0 > relocatingConfig.txt
REM java -jar converter.jar --headless -- "srcWorld './RESULT3'" "dstWorld './RESULT4'" "inFormat CubicChunks" "outFormat CubicChunks" "converter Relocating"
REM 
REM java -jar converter.jar --headless -- "srcWorld './test1'" "dstWorld './RESULT4'" "inFormat Anvil" "outFormat CubicChunks" "converter Default"
echo move all by 0 -16 0 > relocatingConfig.txt
java -Xmx2G -XX:+UnlockExperimentalVMOptions -XX:+UseG1GC -XX:G1NewSizePercent=20 -XX:G1ReservePercent=20 -XX:MaxGCPauseMillis=50 -XX:G1HeapRegionSize=32M -jar converter.jar --headless -- "srcWorld './RESULT4'" "dstWorld './RESULT5'" "inFormat CubicChunks" "outFormat CubicChunks" "converter Relocating"

java -Xmx2G -XX:+UnlockExperimentalVMOptions -XX:+UseG1GC -XX:G1NewSizePercent=20 -XX:G1ReservePercent=20 -XX:MaxGCPauseMillis=50 -XX:G1HeapRegionSize=32M -jar converter.jar --headless -- "srcWorld './test2'" "dstWorld './RESULT5'" "inFormat Anvil" "outFormat CubicChunks" "converter Default"
echo move all by 0 32 0 > relocatingConfig.txt
java -Xmx2G -XX:+UnlockExperimentalVMOptions -XX:+UseG1GC -XX:G1NewSizePercent=20 -XX:G1ReservePercent=20 -XX:MaxGCPauseMillis=50 -XX:G1HeapRegionSize=32M -jar converter.jar --headless -- "srcWorld './RESULT5'" "dstWorld './RESULT'" "inFormat CubicChunks" "outFormat CubicChunks" "converter Relocating"

rem "converter Default"
rem "converter Relocating"
