...
echo move all by 0 -48 0 > relocatingConfig.txt
...
java -Xmx4G -XX:+UnlockExperimentalVMOptions -XX:+UseG1GC -XX:G1NewSizePercent=20 -XX:G1ReservePercent=20 -XX:MaxGCPauseMillis=50 -XX:G1HeapRegionSize=32M -jar converter.jar --headless -- "srcWorld './test2'" "dstWorld './RESULT3'" "inFormat Anvil" "outFormat CubicChunks" "converter Default"
echo move all by 0 16 0 > relocatingConfig.txt
...
java -Xmx4G -XX:+UnlockExperimentalVMOptions -XX:+UseG1GC -XX:G1NewSizePercent=20 -XX:G1ReservePercent=20 -XX:MaxGCPauseMillis=50 -XX:G1HeapRegionSize=32M -jar converter.jar --headless -- "srcWorld './test0'" "dstWorld './RESULT5'" "inFormat Anvil" "outFormat CubicChunks" "converter Default"

rem echo move all by 0 32 0 > relocatingConfig.txt
rem java -Xmx4G -XX:+UnlockExperimentalVMOptions -XX:+UseG1GC -XX:G1NewSizePercent=20 -XX:G1ReservePercent=20 -XX:MaxGCPauseMillis=50 -XX:G1HeapRegionSize=32M -jar converter.jar --headless -- "srcWorld './RESULT5'" "dstWorld './RESULT'" "inFormat CubicChunks" "outFormat CubicChunks" "converter Relocating"
