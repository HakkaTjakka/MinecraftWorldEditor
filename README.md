...
Warning: This "junk code" made by a "code junkie". If you want to do something with it, ask, i write manual for you. Your wish is my command.
...
(Click to play vid)
***
[![Demo CountPages alpha](https://github.com/HakkaTjakka/MinecraftWorldEditor/blob/master/Untitled.jpg)](https://www.youtube.com/watch?v=EIRvaGTWDZI)
(Click to play vid)
***
