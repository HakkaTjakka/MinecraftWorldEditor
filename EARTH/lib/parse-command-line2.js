...
module.exports = function parseCommandLine(filename) {
	...
	if (octants.length === 0 || max_level === undefined) {
		...
		if (optional.filter(o => !['--dump-json', '--dump-raw', '--parallel-search','--AZORES','--RIO','--UTRECHT','--ENSCHEDE','--MIAMI','--DENHAAG','--SCHWEIZ', '--AMSTERDAM', '--BRUSSEL',  '--LA',  '--NEWYORK', '--JOCELYN' ].includes(o)).length > 0) errors.push('Invalid parameters.');
	}
	if (errors.length > 0) {
