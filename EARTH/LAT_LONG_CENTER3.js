...
*/		
		...
		if (numberOffoundOctants_extra>0) {
			console.log('	static std::string *octants['+(num_lats+1)+'];');
		} else {
			console.log('	static std::string *octants['+(num_lats)+'];');
		}
		console.log('	static std::string *lat_lon['+(num_lats)+'];');
		console.log('	static int first_do=1;');
		console.log('	if (x<0 || y<0) {');
        console.log('		x='+num_lats+';y='+num_lons+';');
		console.log('		extra_octants='+(numberOffoundOctants_extra)+';');
        console.log('		return "";');
		console.log('	}');
		console.log('	bool OK=false;');
		if (numberOffoundOctants_extra>0) {
			console.log('	if (x=='+(num_lats)+' && y>'+(numberOffoundOctants_extra-1)+') printf("Out of bound: %s X=%d Y=%d\\n",area.c_str(),x,y);');
			console.log('	else if (!(x=='+(num_lats)+') && (x>'+(num_lats-1)+' || y>'+(num_lons-1)+')) printf("Out of bound: %s X=%d Y=%d\\n",area.c_str(),x,y);');
			console.log('	else OK=true;');
		} else {
			console.log('	if (x>'+(num_lats-1)+' || y>'+(num_lons-1)+') printf("Out of bound: %s X=%d Y=%d\\n",area.c_str(),x,y);');
			console.log('	else OK=true;');
		}
		...
		if (numberOffoundOctants_extra>0) {
			...
			row_cc_extra='		octants['+num_lats+']=new std::string['+numberOffoundOctants_extra+'] '+row_cc_extra;
		...
		console.log('	}');
		console.log('	if (!(x=='+(num_lats)+')) latitude_longditude=lat_lon[x][y];');
