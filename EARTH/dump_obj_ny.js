...
const [ DUMP_NEW_DIR,		DUMP_NEW_DIR_BRUSSEL,		DUMP_NEW_DIR_ENSCHEDE,		DUMP_NEW_DIR_LA,		DUMP_NEW_DIR_AMSTERDAM,		DUMP_OBJ_DIR,		DUMP_JSON_DIR,		DUMP_RAW_DIR	] =
	  [	'new',			  	'new/NewYork',	  			'new/Enschede',	  			'new/LA',				'new/Amsterdam',			'obj',				'json',				'raw' 		  	].map(x => path.join(DL_DIR, x));
...
//use offset (first line of a test .obj file) for more precission when loading .obj files. Instead of the center/rescale. So sep. object files/dirs combine when rendered.
//reverse when needed original coords.
//		const offset_x=0.0;
//		const offset_y=0.0;
//		const offset_z=0.0;
//enschede....		
...
//brussel....		
//		const offset_x=139820.0;
//		const offset_y=-171608.0;
//		const offset_z=-97433;
//new york
		const offset_x=1347086.0;
		const offset_y=-4648439;
		const offset_z=4143313;
