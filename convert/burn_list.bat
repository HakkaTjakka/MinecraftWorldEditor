...
rem ffmpeg -hide_banner -y -itsoffset -1.0 -i "!short!_subs_cut_a.srt" "!short!_subs_cut.srt"
...
rem ffmpeg.exe -hide_banner -y -ss 01:19:16 -t 00:03:01 -i "!short!_subs.mkv" -ss 00:00:00 -stream_loop -1 -i logo.avi -filter_complex "[0:v]pad=1920:835:-1:49:color=#ffffff[q];[q]pad=1920:933:-1:49:color=#ff0000[j];[j]scale=1920:1031:force_original_aspect_ratio=decrease[p];[p]pad=1920:933:-1:99:color=#ff5000[h];[h]pad=1920:1031:-1:150:color=#0000ff[j];[j][1:v]overlay=shortest=1:x=0:y=0[l];[l]subtitles=f='!short!_subs_cut.srt':force_style='FontName=Arial,FontSize=32,Shadow=1'[k]" -map "[k]" -map 0:a -strict -2  -c:s mov_text -c:v h264_nvenc -profile:v high -pix_fmt yuv420p -bufsize 20M -bf:v 3 -b:v 2.0M -preset slow -rc:v vbr_hq -rc-lookahead 32 -shortest "!short!.nl.mp4"

ffmpeg.exe -hide_banner -y -ss 01:19:16 -t 00:03:01 -i "!short!_subs.mkv" -ss 00:00:00 -stream_loop -1 -i logo.avi -filter_complex "[0:v]scale=1920:1080:force_original_aspect_ratio=decrease[p];[p]pad=1920:1080:-1:148:color=#ff5000[j];[j][1:v]overlay=shortest=1:x=0:y=0[l];[l]subtitles=f='!short!_subs_cut.srt':force_style='FontName=Arial,FontSize=32,Shadow=1'[k]" -map "[k]" -map 0:a -strict -2  -c:s mov_text -c:v h264_nvenc -profile:v high -pix_fmt yuv420p -bufsize 20M -bf:v 3 -b:v 2.0M -preset slow -rc:v vbr_hq -rc-lookahead 32 -shortest "!short!.nl.mp4"

rem ffmpeg.exe -hide_banner -y -ss 01:19:16 -t 00:03:01 -i "!short!_subs.mkv" -ss 00:00:00 -stream_loop -1 -i logo.avi -filter_complex "[0:v]scale=1920:1080:force_original_aspect_ratio=decrease[p];[p]pad=1920:933:-1:49:color=#ff5000[i];[i]pad=1920:982:-1:49:color=#0000ff[h];[h]pad=1920:1031:-1:49:color=#ffffff[f];[f]pad=1920:1080:-1:49:color=#ff0000[j];[j][1:v]overlay=shortest=1:x=0:y=0[l];[l]subtitles=f='!short!_subs_cut.srt':force_style='FontName=Arial,FontSize=32,Shadow=1'[k]" -map "[k]" -map 0:a -strict -2  -c:s mov_text -c:v h264_nvenc -profile:v high -pix_fmt yuv420p -bufsize 20M -bf:v 3 -b:v 2.0M -preset slow -rc:v vbr_hq -rc-lookahead 32 -shortest "!short!.nl.mp4"

rem ffmpeg.exe -hide_banner -y -ss 01:19:16 -t 00:03:01 -i "!short!_subs.mkv" -ss 00:00:00 -stream_loop -1 -i logo.avi -filter_complex "[0:v]scale=1920:982:force_original_aspect_ratio=decrease[p];[p]pad=1920:935:-1:150:color=#ff5000[i];[i]pad=1920:982:-1:49:color=#0000ff[h];[h]pad=1920:1031:-1:49:color=#ffffff[f];[f]pad=1920:1080:-1:150:color=#ff0000[j];[j][1:v]overlay=shortest=1:x=0:y=0[l];[l]subtitles=f='!short!_subs_cut.srt':force_style='FontName=Arial,FontSize=32,Shadow=1'[k]" -map "[k]" -map 0:a -strict -2  -c:s mov_text -c:v h264_nvenc -profile:v high -pix_fmt yuv420p -bufsize 20M -bf:v 3 -b:v 2.0M -preset slow -rc:v vbr_hq -rc-lookahead 32 -shortest "!short!.nl.mp4"
