...
ffmpeg -y -hide_banner -i long-oLXioQvGihg.en.mp4 -async 1 -c:v h264_nvenc -profile:v high -pix_fmt yuv420p -bufsize 20M -b:v 10K -bf:v 3 -preset slow -rc:v vbr_hq -rc-lookahead 32 -c:a aac -b:a 64k "NEW_EN_SHORT.MP4"
...
rem 
rem if exist mylist3.txt del mylist3.txt
rem (for %%i in (NEW_EN2*.mp4) do (
rem 	echo file '%%i') >> mylist3.txt
rem )
rem ffmpeg -y -safe 0 -f concat -i mylist3.txt -c copy output_long_EN.mp4
...
REM if !total_duration_before5! LSS 0 (
	REM set /A total_duration_before5 = 0
REM }

rem echo ffmpeg -y -hide_banner -ss !total_duration_before5!.!total_duration_after5! -i long-oLXioQvGihg.en.mp4 -ss !total_duration_before2!.!total_duration_after2! -t !duration_before!.!duration_after! -async 1 -c copy "NEW_EN2 - !widget!" >> error.log
rem ffmpeg -y -hide_banner -ss !total_duration_before5!.!total_duration_after5! -i long-oLXioQvGihg.en.mp4 -ss !total_duration_before2!.!total_duration_after2! -t !duration_before!.!duration_after! -async 1 -c:v h264_nvenc -profile:v high -pix_fmt yuv420p -bufsize 20M -b:v 25K -bf:v 3 -preset slow -rc:v vbr_hq -rc-lookahead 32 -c:a aac -b:a 32k "NEW_EN2 - !widget!"
rem ffmpeg -y -hide_banner -ss !total_duration_before5!.!total_duration_after5! -i long-oLXioQvGihg.en.mp4 -ss !total_duration_before2!.!total_duration_after2! -t !duration_before!.!duration_after! -async 1 -c:v h264_nvenc -profile:v high -pix_fmt yuv420p -bufsize 20M -b:v 10K -bf:v 3 -preset slow -rc:v vbr_hq -rc-lookahead 32 -c:a aac -b:a 32k "NEW_EN2 - !widget!"
ffmpeg -y -hide_banner -ss !total_duration_before5!.!total_duration_after5! -i long-oLXioQvGihg.en.mp4 -ss !total_duration_before4!.!total_duration_after4! -t !duration_before!.!duration_after! -async 1 -c:v h264_nvenc -profile:v high -pix_fmt yuv420p -bufsize 20M -b:v 10K -bf:v 3 -preset slow -rc:v vbr_hq -rc-lookahead 32 -c:a aac -b:a 64k "NEW_EN2 - !widget!"
rem ffmpeg -y -hide_banner -ss !total_duration_before5!.!total_duration_after5! -i long-oLXioQvGihg.en.mp4 -ss !total_duration_before4!.!total_duration_after4! -t !duration_before!.!duration_after! -async 1 -c copy "NEW_EN2 - !widget!"
